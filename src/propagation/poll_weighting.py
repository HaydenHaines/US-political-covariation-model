...
def apply_all_weights(
    ...
    """Apply house effect correction, time decay, and pollster quality weighting.
    ...
    Processing order (matches the intended inference pipeline):
      ...
      2. Time decay (reduces effective N for older polls).
      3. Pollster quality (rescales effective N by quality grade).
